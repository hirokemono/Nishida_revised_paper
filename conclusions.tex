...
%, so that further numerical simulations of geodynamo are required to investigate the range of $Ra$ for self-sustained dynamos by imposing a boundary condition of fixed heat flux.
% }
...
% \noindent
% he numerical code, Calypso Ver.~1.2, used in this study is available from the following URL,
