...
%
The obtained values of $Ra_{\rm crit}$ are almost identical to those reported by \citet{AlShamali:2004} for the same parameters and conditions used in this study. 
%
...
The dynamic Elsasser number, $\Lambda_d$, represents the relative strength of the Lorentz to Coriolis forces defined by \citet{Soderlund:2012}.
...
This is consistent with a result of \citet{Heimpel:2005}, where all the $E_{\rm mag}$ values are also smaller than the $E_{\rm kin}$ values at $E = 4.0 \times 10^{-4}$ and $Pm = 5$ for $r_i / r_o = 0.15$.
