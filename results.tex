...
We calculated the time average of the kinetic and magnetic energy density, as well as the dipolarity over a 0.5 magnetic diffusion time, at the end of each case (see shaded area in Fig. \ref{fig:fig_2}). The kinetic and magnetic energy density as a function of Rayleigh number is shown in Fig.~3.%, where the black, red, and blue points are the E_kin values in the non-MHD cases, E_kin values in the MHD cases, and E_mag values in the MHD cases, respectively. The “F” denotes the failed dynamo cases. 
% Reviewer # のコメントに従い削除
