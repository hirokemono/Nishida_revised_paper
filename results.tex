...
% \begin{table*}
% % \begin{center}
% \caption{Time average of the magnetic Reynolds number $Rm$, kinetic energy $E_{\rm kin}$, magnetic energy $E_{\rm mag}$, dipolarity $f_{\rm dip}$, and {\color{red} and the dynamic Elsasser number $\Lambda_{d}$ for the cases with $E = 1.0 \times 10^{-3}$, $Pm = 5.0$, and} $r_{\rm i}/r_{\rm o} = 0.15$.}
%   \begin{tabular}{cccccccccc}
%       \hline
%      $Ra[\times 10^3]$  &  $Ra/Ra_{\rm crit}$&
%      {\color{red} $L_{\rm max}$} & {\color{red} $N_{r}$} & {\color{red} $Rm$} & $E_{\rm kin}$  &  $E_{\rm mag}$ & $f_{\rm dip}$ & $f_{\rm mag\_fit}$ & $\Lambda_{\rm d}$\\
%     \hline
...
% \begin{table*}
% %\begin{center}
% \caption{Time average of the magnetic Reynolds number $Rm$, kinetic energy $E_{\rm kin}$, magnetic energy $E_{\rm mag}$, dipolarity $f_{\rm dip}$, and {\color{red} the dynamic Elsasser number $\Lambda_{d}$ for the cases with $E = 1.0 \times 10^{-3}$, $Pm = 5.0$, and} $r_{\rm i}/r_{\rm o} = 0.25$.}
%   \begin{tabular}{cccccccccc}
%     \hline
%      $Ra[\times 10^3]$  &  $Ra/Ra_{\rm crit}$& 
%      {\color{red} $L_{\rm max}$} & {\color{red} $N_{r}$} & {\color{red} $Rm$} & $E_{\rm kin}$  &  $E_{\rm mag}$ & $f_{\rm dip}$ & $f_{\rm mag\_fit}$ & $\Lambda_{\rm d}$\\
...
% \begin{table*}
% % \begin{center}
% \caption{Time average of the magnetic Reynolds number $Rm$, kinetic energy $E_{\rm kin}$, magnetic energy $E_{\rm mag}$, dipolarity $f_{\rm dip}$, and {\color{red} the dynamic Elsasser number $\Lambda_{d}$ for the cases with $E = 1.0 \times 10^{-3}$, $Pm = 5.0$, and} $r_{\rm i}/r_{\rm o} = 0.35$.}
%   \begin{tabular}{cccccccccc}
%     \hline
%      $Ra[\times 10^3]$  &  $Ra/Ra_{\rm crit}$& 
%      {\color{red} $L_{\rm max}$} & {\color{red} $N_{r}$} & {\color{red} $Rm$} & $E_{\rm kin}$  &  $E_{\rm mag}$ & $f_{\rm dip}$ & $f_{\rm mag\_fit}$ & $\Lambda_{\rm d}$\\
...
% % \begin{center}
% {\color{red}
% \caption{Time average of the magnetic Reynolds number $Rm$, kinetic energy $E_{\rm kin}$, magnetic energy $E_{\rm mag}$, dipolarity $f_{\rm dip}$, and the dynamic Elsasser number $\Lambda_{d}$ for the cases with $E = 1.0 \times 10^{-4}$, $Pm = 2.0$, and $r_{\rm i}/r_{\rm o} = 0.15$.}
% }
% {\color{red}
%   \begin{tabular}{cccccccccc}
%     \hline
...
% % \begin{center}
% {\color{red}
% \caption{Time average of the magnetic Reynolds number $Rm$, kinetic energy $E_{\rm kin}$, magnetic energy $E_{\rm mag}$, dipolarity $f_{\rm dip}$, and the dynamic Elsasser number $\Lambda_{d}$ for the cases with $E = 1.0 \times 10^{-4}$, $Pm = 2.0$, and $r_{\rm i}/r_{\rm o} = 0.25$.}
% }
% {\color{red}
%   \begin{tabular}{cccccccccc}
%     \hline
...
%       433.3 & 5.278 & 95 & 95 & 89.68 & 1408 & 1360 & 0.8091 & 32.87 & 0.03626 \\
%       650 & 7.917 & 95 & 95 & 118.9 & 1774 & 6706 & 0.7118 & 26.39 & 0.2260 \\
%       866.7 & 10.56 & 95 & 95 & 141.6 & 2518 & 12212 & 0.6980 & 33.44 & 0.2746 \\
%       1733 & 21.11 & 95 & 95 & 269.4 & 9101 & 18615 & 0.4207 & 12.41 & 0.2746 \\
%       3467 & 42.22 & 95 & 95 & 543.0 & 36954 & 11862 & 0.02337 & 0.9429 & 0.1560 \\
%     \hline
%   \end{tabular}
%  }
% % \end{center}
...
% % \begin{center}
% {\color{red}
% \caption{Time average of the magnetic Reynolds number $Rm$, kinetic energy $E_{\rm kin}$, magnetic energy $E_{\rm mag}$, dipolarity $f_{\rm dip}$, and dynamic Elsasser number $\Lambda_{d}$ for the cases with $E = 1.0 \times 10^{-4}$, $Pm = 2.0$, and $r_{\rm i}/r_{\rm o} = 0.35$.}
% }
% {\color{red}
%   \begin{tabular}{cccccccccc}
%     \hline
...
%       3.0 & 4.314 & 95 & 95 & 79.06 & 783.2 & 1485 & 0.7507 & 3.740 & 0.05238 \\
%       4.0 & 5.752 & 95 & 95 & 96.65 & 1174 & 5307 & 0.7429 & 29.59 & 0.1581 \\
%       5.0 & 7.190 & 95 & 95 & 106.4 & 1421 & 11133 & 0.7566 & 41.54 & 0.2840 \\
%       7.5 & 10.79 & 95 & 95 & 161.9 & 3294 & 18096 & 0.5862 & 23.89 &  0.3724 \\
%       10.0 & 14.38 & 95 & 95 & 222.8 & 6226 & 19662 & 0.4417 & 13.352 &  0.3671 \\
%       15.0 & 21.57 & 95 & 95 & 328.4 & 13481 & 22715 & 0.3138 & 9.896 &  0.3690  \\
%       20.0 & 28.76 & 95 & 95 & 503.0 & 31679 & 10105 & 0.01102 & 0.6228 & 0.1651 \\
%     \hline
%   \end{tabular}
%  }
% % \end{center}
...
%
{\color{green} % よくわからない
% As these intense $z$-components of the magnetic field are not concentrated in the convection columns, there is no correspondent radial magnetic field near the tangent cylinder at the CMB. 
% The radial magnetic field at the CMB near the tangent cylinder has a quadrupolar (symmetric with respect to the equator) component which does not appear in the $z$-component of the magnetic field on the equatorial plane.
