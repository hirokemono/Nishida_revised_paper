...
\begin{array}{l}
\displaystyle
\frac{\partial {\vec u}}{\partial t} + \left({\boldmath \omega} \omega \times \vec{u}\right)
...
In eq.~(\ref{eq:momentum}), $\vec{\omega} = \bnabla \times \vec{u}$ is the vorticity, and $\vec{J} = \bnabla \times \vec{B} / \mu_0$ in the dimensional form is the current density, where $\mu_0$ is the magnetic permeability of vacuum.
